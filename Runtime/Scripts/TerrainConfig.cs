...
namespace Spellbound.MarchingCubes {
    ...
    public class TerrainConfig : ScriptableObject {
        ...
        [Header("Advance/Derived Settings")]
        ...
        private void ComputeLods(out int chunkSize, out int lodCount, out Vector2[] lodRadii) {
            ...
            List<Vector2> radiiList = new List<Vector2>();

            for (int n = 0; n < lodCount; n++) {
                float currentChunkSize = cubesPerMarch * Mathf.Pow(2, n);
                ...
                float radius = lodRangeScale * cubesPerMarch * (Mathf.Pow(2, n + 1) - 1);
