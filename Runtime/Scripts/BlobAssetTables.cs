...
namespace SpellBound.MarchingCubes{
    public struct MCTablesBlobAsset {
        ...
        public BlobArray<long> VertexCount;
        public BlobArray<long> TriangleCount;
        public BlobArray<BlobArray<byte>> Indices;
        ...
        public BlobArray<long> TransitionVertexCount;
        public BlobArray<long> TransitionTriangleCount;
        public BlobArray<BlobArray<byte>> TransitionIndices;
    ...
    public class MCTablesBlobCreator {
        public static BlobAssetReference<MCTablesBlobAsset> CreateMCTablesBlobAsset() {
            ...
            // TransitionCornerOffsets
            int3[] transitionCornerOffset = {
                new(0, 0, 0), // 0	      B-----------C
                new(1, 0, 0), // 1         /|          /|
                new(2, 0, 0), // 2        / |         / |	         
                new(0, 1, 0), // 3       /  |        /  |                       
            ...
            byte[] transitionGeometryCount = {
                ...
                0xB7, 0x75, 0xA6, 0xC4, 0x86, 0x64, 0x86, 0x97, 0xA6, 0xC8, 0x97, 0x97, 0xB7, 0xA8, 0xB9, 0xA6,
                0xC6, 0xB7, 0xA8, 0xCC, 0x86, 0x97, 0xA8, 0xA8
            };
